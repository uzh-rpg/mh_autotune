...
class AutoTune():
  def __init__(self):
    ...
    self.bounds = {"0": rospy.get_param("/autotune_node/B_pos_x"),
                   "1": rospy.get_param("/autotune_node/B_pos_y"),
                   "2": rospy.get_param("/autotune_node/B_pos_z"),
                   "3": rospy.get_param("/autotune_node/B_att_x"),
                   "4": rospy.get_param("/autotune_node/B_att_y"),
                   "5": rospy.get_param("/autotune_node/B_att_z"),
                   "6": rospy.get_param("/autotune_node/B_vel"),
                   "7": rospy.get_param("/autotune_node/B_omega"),
                   "8": rospy.get_param("/autotune_node/B_horizon")}
    ...
    self.drone = drone.Quadrotor(self.z_offset, self.L_pivots, self.resources_path, self.file_name, self.parameters_path)
